...
# CONFIGURATION
# ========================================
BASE_URL = "https://www.cloudveil.org"
CARD_COUNTRY = "BD"
...
class PaymentMethodAdder:
    """Handles the complete flow of adding payment methods to WooCommerce for Cloudveil"""
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                if not register_nonce:
                    ...
                    if nonce_input:
                        register_nonce = nonce_input.get('value')
                        print(f"✅ Registration nonce extracted via soup: {register_nonce}")
...
def handle_endpoint(auth, hcaptcha_token='', email=None, password=None, proxy=None):
    """
    Main endpoint handler for Cloudveil payment validation
